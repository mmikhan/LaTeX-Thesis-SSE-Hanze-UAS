...
\begin{figure}[H]
    \hspace{8cm}
    \includegraphics[width=4cm]{signature.png}  % Place an image of your signature in location: images/signature.png
    % Note how figures without \caption{} do not appear in the list of figures (same holds for tables)
\end{figure}

\noindent\hspace{8cm}Md Mazedul Islam Khan  % Replace with your name
